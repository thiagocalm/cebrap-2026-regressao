...
## Natureza dos dados {.theme-subtopic .smaller}
...
**Exemplos**: [Atividades culturais, peso das pessoas ao nascer]{.gap}
:::
::::
:::::::
...
Valores representam atributos ou qualidades.

- **Nominal** (não ordenado) - pode ainda ser dividida em binária ou não.

  - Ex.: sexo/gênero, UF, nomes.

- **Ordinal** (ordenado/graduado)
...
- **Discreta** (contagem) - expressa em números inteiros, "indivisíveis".

  - Ex.: anos de estudos, número de filhos, pessoas no domicílio.
...
Nos diz se temos evidênciais suficientes para aceitar a hipótese de que há diferença entre elas.
:::
...
a.  Um aumento da renda teria um efeito direto de \~45% no aumento da nota de matemática.

b.  Um aumento da nota de matemática teria um efeito direto de \~45% no aumento da renda.
...
5.  Implementar o modelo populacional para a amostra da população que temos acesso
...
Sabendo-se quais são os fatores que determinam um fenômeno social $Y$, pode-se predizer o comportamento futuro $\hat{Y}$ com base nas mudanças que ocorrerão em seus fatores determinantes.
...
Buscam estabelcer a relação entre um fenômeno $X_1$ e o fenômeno de interesse $Y$ a partir do *controle* por outras variáveis que também podem afetar $Y$[^2]

- Mais comuns em estudos de políticas públicas para desenho de programas sociais, em estudos acadêmicos ou em estudos de mercado.
:::
:::::
