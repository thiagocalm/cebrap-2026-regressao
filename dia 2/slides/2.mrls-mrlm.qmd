...
## []{.theme-subtopic} {.font-size-smallest}
...
[^1]: **i.i.d.** = **i**ndependente e **i**dênticamente **d**istribuída.
...
Estudo das propriedades da nossa **variável de estudo** através de relações associadas ao melhor modelo probabilístico que descreve essa variável.
...
- **Associação/Causalidade**: Estabelecer em que medida variando uma das variáveis, os valores da variável de interesse também varia (probabilidade condicional a um $X$)
...
Conhecendo-se as propriedades de uma variável aleatória, pode-se relacionar duas variáveis aleatórias, de modo que:
...
Portanto, tudo o que precisamos saber é qual o modelo probabilístico -- $f(\cdot)$ -- se associa a determinado fenômeno social, que trataremos como uma $v.a.$. A partir disso, podemos relacionar esse fenômeno social de interesse com outros fenômenos -- outras $v.a.$
...
Estas são chamadas de **variáveis controle/confundidoras/co-variáveis**[^1].

[^1]: *Em geral*, seus resultados não são explicados, mas são explicitados.
